...
### 〇、总则
为了让尽可能多的人不需学习、只需简单了解就可以很快掌握三叶语的发音，三叶语语音设计遵循如下原则：
...
<p>Note that p, t, k are aspirated-voiceless-stop consonants, sounds p<sup>h</sup>, t<sup>h</sup>, k<sup>h </sup>respectively. For the non-writen consonants, the corresponding letters are listed below, including two digraphs:
</p>
<ul><li> [ʦ] = c
</li><li> [ɹ] = r
</li><li> [dʒ] = j
...
#### 元音
<p>Klovien's vowels are more like French or Chinese, but they are the easiest parts for English speakers too.  There are 7 basic vowels:
</p>
...
<p>We omit the diacritic signs thereafter to keep it simple.</p>
...
例如edukutisto(教育学家)，音节划分为 e-du-ku-ti-sto，重音分别在“e”和“ti”上。
